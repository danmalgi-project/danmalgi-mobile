  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.signaling.v1.SignalingRequestInfo',
...
final $typed_data.Uint8List signalingRequestDescriptor = $convert.base64Decode(
    'ChBTaWduYWxpbmdSZXF1ZXN0ElgKFnNpZ25hbGluZ19yZXF1ZXN0X2luZm8YASABKAsyIi5zaW'
    'duYWxpbmcudjEuU2lnbmFsaW5nUmVxdWVzdEluZm9SFHNpZ25hbGluZ1JlcXVlc3RJbmZv');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.signaling.v1.SignalingResponseInfo',
...
final $typed_data.Uint8List signalingResponseDescriptor = $convert.base64Decode(
    'ChFTaWduYWxpbmdSZXNwb25zZRJbChdzaWduYWxpbmdfcmVzcG9uc2VfaW5mbxgBIAEoCzIjLn'
    'NpZ25hbGluZy52MS5TaWduYWxpbmdSZXNwb25zZUluZm9SFXNpZ25hbGluZ1Jlc3BvbnNlSW5m'
    'bw==');
...
final $typed_data.Uint8List signalingRequestInfoDescriptor = $convert.base64Decode(
    'ChRTaWduYWxpbmdSZXF1ZXN0SW5mbxIuCgZhbnN3ZXIYASABKAsyFC5zaWduYWxpbmcudjEuQW'
    '5zd2VySABSBmFuc3dlchI3CgljYW5kaWRhdGUYAiABKAsyFy5zaWduYWxpbmcudjEuQ2FuZGlk'
    'YXRlSABSCWNhbmRpZGF0ZUIJCgdtZXNzYWdl');
...
final $typed_data.Uint8List signalingResponseInfoDescriptor = $convert.base64Decode(
    'ChVTaWduYWxpbmdSZXNwb25zZUluZm8SKwoFb2ZmZXIYASABKAsyEy5zaWduYWxpbmcudjEuT2'
    'ZmZXJIAFIFb2ZmZXISLgoGYW5zd2VyGAIgASgLMhQuc2lnbmFsaW5nLnYxLkFuc3dlckgAUgZh'
    'bnN3ZXISNwoJY2FuZGlkYXRlGAMgASgLMhcuc2lnbmFsaW5nLnYxLkNhbmRpZGF0ZUgAUgljYW'
    '5kaWRhdGVCCQoHbWVzc2FnZQ==');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.signaling.v1.SessionDescription',
      '10': 'sdp'
    },
    {
...
final $typed_data.Uint8List offerDescriptor = $convert.base64Decode(
    'CgVPZmZlchIyCgNzZHAYASABKAsyIC5zaWduYWxpbmcudjEuU2Vzc2lvbkRlc2NyaXB0aW9uUg'
    'NzZHASSwoSam9pbmVkX3VzZXJfdHJhY2tzGAIgASgLMhguc2lnbmFsaW5nLnYxLlVzZXJUcmFj'
    'a3NIAFIQam9pbmVkVXNlclRyYWNrc4gBAUIVChNfam9pbmVkX3VzZXJfdHJhY2tz');
...
final $typed_data.Uint8List answerDescriptor = $convert.base64Decode(
    'CgZBbnN3ZXISMgoDc2RwGAEgASgLMiAuc2lnbmFsaW5nLnYxLlNlc3Npb25EZXNjcmlwdGlvbl'
    'IDc2Rw');
...
final $typed_data.Uint8List userTracksDescriptor = $convert.base64Decode(
    'CgpVc2VyVHJhY2tzEjgKC3VzZXJfdHJhY2tzGAEgAygLMhcuc2lnbmFsaW5nLnYxLlVzZXJUcm'
    'Fja1IKdXNlclRyYWNrcw==');
...
final $typed_data.Uint8List userTrackDescriptor = $convert.base64Decode(
    'CglVc2VyVHJhY2sSIQoEdXNlchgBIAEoCzINLnVzZXIudjEuVXNlclIEdXNlchIZCgh0cmFja1'
    '9pZBgCIAEoCVIHdHJhY2tJZBI2Cgp0cmFja190eXBlGAMgASgOMhcuc2lnbmFsaW5nLnYxLlRy'
    'YWNrVHlwZVIJdHJhY2tUeXBl');
