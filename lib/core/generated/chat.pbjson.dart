...
final $typed_data.Uint8List getPreviousMessagesResponseDescriptor =
    $convert.base64Decode(
        'ChtHZXRQcmV2aW91c01lc3NhZ2VzUmVzcG9uc2USJwoIbWVzc2FnZXMYASADKAsyCy5wYi5NZX'
...
final $typed_data.Uint8List receiveMessageResponseDescriptor = $convert.base64Decode(
    'ChZSZWNlaXZlTWVzc2FnZVJlc3BvbnNlEiUKB21lc3NhZ2UYASABKAsyCy5wYi5NZXNzYWdlUg'
    'dtZXNzYWdlEikKBnN0YXR1cxgCIAEoDjIRLnBiLk1lc3NhZ2VTdGF0dXNSBnN0YXR1cw==');

@$core.Deprecated('Use sendHeartBeatRequestDescriptor instead')
const SendHeartBeatRequest$json = {
  '1': 'SendHeartBeatRequest',
  '2': [
    {'1': 'channel_id', '3': 1, '4': 1, '5': 3, '10': 'channelId'},
  ],
};

/// Descriptor for `SendHeartBeatRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sendHeartBeatRequestDescriptor = $convert.base64Decode(
    'ChRTZW5kSGVhcnRCZWF0UmVxdWVzdBIdCgpjaGFubmVsX2lkGAEgASgDUgljaGFubmVsSWQ=');
...
final $typed_data.Uint8List messageDescriptor = $convert.base64Decode(
    ...
    'gJUgdjb250ZW50EhIKBGZpbGUYAyABKAlSBGZpbGUSHAoEdXNlchgEIAEoCzIILnBiLlVzZXJS'
    'BHVzZXISOQoKY3JlYXRlZF9hdBgFIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSCW'
    'NyZWF0ZWRBdBI5Cgp1cGRhdGVkX2F0GAYgASgLMhouZ29vZ2xlLnByb3RvYnVmLlRpbWVzdGFt'
    'cFIJdXBkYXRlZEF0Eg4KAmlkGAcgASgDUgJpZBIbCglpc19hdXRob3IYCCABKAhSCGlzQXV0aG'
    '9y');
