...
final $typed_data.Uint8List getOutgoingRelationshipListResponseDescriptor =
    $convert.base64Decode(
        'CiNHZXRPdXRnb2luZ1JlbGF0aW9uc2hpcExpc3RSZXNwb25zZRI2Cg1yZWxhdGlvbnNoaXBzGA'
        'EgAygLMhAucGIuUmVsYXRpb25zaGlwUg1yZWxhdGlvbnNoaXBz');
...
final $typed_data.Uint8List getIncomingRelationshipListResponseDescriptor =
    $convert.base64Decode(
        'CiNHZXRJbmNvbWluZ1JlbGF0aW9uc2hpcExpc3RSZXNwb25zZRI2Cg1yZWxhdGlvbnNoaXBzGA'
        'EgAygLMhAucGIuUmVsYXRpb25zaGlwUg1yZWxhdGlvbnNoaXBz');
...
final $typed_data.Uint8List addRelationshipResponseDescriptor =
    $convert.base64Decode(
        'ChdBZGRSZWxhdGlvbnNoaXBSZXNwb25zZRI2Cg1yZWxhdGlvbnNoaXBzGAEgAygLMhAucGIuUm'
        'VsYXRpb25zaGlwUg1yZWxhdGlvbnNoaXBz');
...
final $typed_data.Uint8List updateIncomingRelationshipStatusRequestDescriptor =
    $convert.base64Decode(
        ...
        'lwX2lkGAEgASgDUg5yZWxhdGlvbnNoaXBJZBJHChNyZWxhdGlvbnNoaXBfc3RhdHVzGAIgASgO'
        'MhYucGIuUmVsYXRpb25zaGlwU3RhdHVzUhJyZWxhdGlvbnNoaXBTdGF0dXM=');
...
final $typed_data.Uint8List updateIncomingRelationshipStatusResponseDescriptor =
    $convert.base64Decode(
        'CihVcGRhdGVJbmNvbWluZ1JlbGF0aW9uc2hpcFN0YXR1c1Jlc3BvbnNlEjYKDXJlbGF0aW9uc2'
        'hpcHMYASADKAsyEC5wYi5SZWxhdGlvbnNoaXBSDXJlbGF0aW9uc2hpcHM=');
...
final $typed_data.Uint8List updateOutgoingRelationshipStatusResponseDescriptor =
    $convert.base64Decode(
        'CihVcGRhdGVPdXRnb2luZ1JlbGF0aW9uc2hpcFN0YXR1c1Jlc3BvbnNlEjYKDXJlbGF0aW9uc2'
        'hpcHMYASADKAsyEC5wYi5SZWxhdGlvbnNoaXBSDXJlbGF0aW9uc2hpcHM=');
...
final $typed_data.Uint8List relationshipDescriptor = $convert.base64Decode(
    ...
    'IcCgR1c2VyGAIgASgLMggucGIuVXNlclIEdXNlchJHChNyZWxhdGlvbnNoaXBfc3RhdHVzGAMg'
    'ASgOMhYucGIuUmVsYXRpb25zaGlwU3RhdHVzUhJyZWxhdGlvbnNoaXBTdGF0dXM=');
